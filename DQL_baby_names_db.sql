...
GROUP BY year
ORDER BY year;
-- Answer: There was a noticeable gradual decline in more recent years

-- Question 17: How do the years with a spike in birth count for the name 'Christopher' compare?
SELECT year, SUM(births) AS total_births
FROM names
WHERE name = 'Christopher'
GROUP BY year
ORDER BY year;
-- Answer: There was also a noticeable gradual decline in more recent years

-- Question 18: How do the years with a spike in birth count for the name 'Matthew' compare?
SELECT year, SUM(births) AS total_births
FROM names
WHERE name = 'Matthew'
GROUP BY year
ORDER BY year;
-- Answer: There was alsoa noticeable gradual decline in more recent years

-- Question 19: How do the years with a spike in birth count for the name 'Joshua' compare?
SELECT year, SUM(births) AS total_births
FROM names
WHERE name = 'Joshua'
GROUP BY year
...
-- Question 20: How do the years with a spike in birth count for the name 'Jessica' compare?
SELECT year, SUM(births) AS total_births
FROM names
WHERE name = 'Jessica'
GROUP BY year
...
-- Link to summary: https://github.com/ekpoitoro1/Baby_names_Db_Project/blob/main/README.md#baby-names-data-analysis